                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="portlet light profile-sidebar-portlet bordered">
                            ...
                            <div class="profile-usertitle">
                                <div class="profile-usertitle-name"> ${sessionScope.user.username} </div>
                                <div class="profile-usertitle-job"> ${sessionScope.user.email} </div>
                            </div>
                        </div>
                        <!-- END PORTLET MAIN -->
                        <!-- PORTLET MAIN -->
                        <div class="portlet light bordered">
                            <div>
                                <h4 class="profile-desc-title">关于 ${sessionScope.user.username}</h4>
                                <span class="profile-desc-text"> 这个家伙太 TM 帅了 </span>
                            </div>
                        </div>
                        <!-- END PORTLET MAIN -->
                    </div>
                                            ...
                                            <div class="tab-pane active" id="tab_1_1">
                                                <form id="inputForm" role="form" action="/profile/save" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="username" name="username" placeholder="${sessionScope.user.username}" class="form-control required" value="${sessionScope.user.username}" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">手机</label>
                                                        <input type="text" id="phone" name="phone" placeholder="${sessionScope.user.phone}" class="form-control required mobile" value="${sessionScope.user.phone}" /> </div>
                                                    <div class="form-group">
                                                        <label class="control-label">邮箱</label>
                                                        <input type="text" id="email" name="email" placeholder="${sessionScope.user.email}" class="form-control required email" value="${sessionScope.user.email}" /> </div>
