...
<div class="content">
    ...
    <form class="login-form" action="/login" method="post">
        <h3 class="form-title font-green">我的商城</h3>
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="账号" name="loginId" /> </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">密码</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" name="loginPwd" /> </div>
...
<div class="copyright"> 2018 © Lusifer. MyShop. </div>
